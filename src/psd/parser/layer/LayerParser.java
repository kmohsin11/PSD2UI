...
public class LayerParser {
   ...
   // private int lyid;
    ...
    public Map getObjects(){
        return additionalInformationParsers;
    }
...
public int getleft(){
    ...
    private void parseAdditionalSections(PsdInputStream stream, int endPos) throws IOException {
       ...
       // additionalInformationParsers.put("lyid", new LayerIdParser());
          putAdditionalInformationParser(LayerIdParser.TAG, new LayerIdParser(new LayerIdHandler() {
            @Override
